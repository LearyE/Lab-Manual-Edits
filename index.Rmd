---
title: "Leary Ortho Biostats Lab Manual "
author: ""
date: ""
output: html_document
---

<p dir='rtl' align='right'> Last update: 10/21/2019 </p>

<IMG SRC="pic.jpg" ALIGN="right"  height= 400 width= 370 hspace=0 vspace=100/>
...
### Work hour report
Lab member should make a screenshot of the REDCap report and send an email to Ms. Kyeong and Dr. Leary. This must be done before 8 a.m. each Monday. If you missed it, do not hesitate and send a copy as soon as possible. It is highly recommended to send the screenshot on the last day of your work before Monday. In addition, you need to provide a detailed description of your progress for each project during the week (this is separate from that in RedCap).  A good guide is a paragraph on each project with an introduction to any issues or questions you may have in lab meeting.
...
If you miss a deadline, please notify Dr. Leary as soon as possible. We can work together to figure out the issue or problem. Here are some tips to keep in mind. 

*	Plan your work: Understand the purpose of the work, and plan each step so that you will not waste a lot of time before noticing you are in the wrong direction. 

*	Use the right resources: Yes, you should be challenged in your work but you shouldn’t be lost.  Getting help with tools and resources such as using the right algorithm, software or asking others can dramatically decrease the time spent on your work. 

*	Plan for the unexpected: Think about potential problems and work to anticipate them.  **Do not do last minute work** because something always goes wrong!!  You need time to trouble shoot and triple check your work.  Plan for that. 
